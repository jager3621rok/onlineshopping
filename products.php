...
<head>
  ...
  <title>Phone Case Products</title>
        ...
        <div class="col-md-12">
          <div class="filters-content">
            <div class="row grid">
              ...
              if ($proCateID != "") {
                $sqlpro = "SELECT p.proId, p.proImage, p.proName, p.proCost, p.proDesc, p.isShow
